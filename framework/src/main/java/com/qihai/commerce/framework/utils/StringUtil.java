...
public class StringUtil extends StringUtils {
	...
	public static String toString(BigDecimal value) {
		BigDecimal result = BigDecimalUtils.format(value);
	...
	/**
	 * 如果参数value为空，则返回默认值defaultValue
	 * 
	 * @param value
	 * @param defaultValue
	 * @return
	...
	public static String format(String value, Object... params) {
		if (BooleanUtils.isEmpty(value) || BooleanUtils.isEmpty(params)) {
			return null;
		}
